/// @file	AP_MotorsBi.h
/// @brief	Motor control class for Bicopters
#pragma once
...
// servo difinitions
#define AP_MOTORS_CH_SERVO_BI_LEFT    CH_3
#define AP_MOTORS_CH_SERVO_BI_RIGHT    CH_4

#define AP_MOTORS_BI_SERVO_RANGE_DEG_MIN   5   // minimum angle movement of tail servo in degrees
...
public:
	...
	virtual void        output_test_seq(uint8_t motor_seq, int16_t pwm);
...
protected:
	...
	SRV_Channel     *_right_servo; // yaw output channel
	float           _angle_left;                       // Angle of yaw pivot
	float           _thrust_right;
	float           _angle_right;
	float           _thrust_left;
};
